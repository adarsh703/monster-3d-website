...
export default function ProductTextOverlays({ product, scrollProgress }: ProductTextOverlaysProps) {
  ...
  return (
    <div className="relative w-full h-full max-w-7xl mx-auto px-6">
      ...
      >
        <h1 className="text-6xl md:text-8xl font-black mb-4 tracking-tighter drop-shadow-lg uppercase text-white">
          {product.section1.title}
        </h1>
        <p className="text-2xl md:text-3xl font-bold text-[#90EE90] drop-shadow-md uppercase tracking-wider">
      ...
      >
        <h2 className="text-5xl md:text-6xl font-black mb-4 tracking-tight drop-shadow-lg uppercase text-white">
          {product.section2.title}
        </h2>
        <p className="text-xl md:text-2xl text-[#90EE90] font-bold drop-shadow-md uppercase tracking-wider">
      ...
      >
        <h2 className="text-5xl md:text-7xl font-black mb-4 tracking-tight drop-shadow-lg uppercase text-white">
